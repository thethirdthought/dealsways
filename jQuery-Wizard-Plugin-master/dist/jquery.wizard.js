        ...
        that.$element.find('.steps > li').on('click', function(e) {
            ...
            checkStatus = function() {
                ...
                if (that.currentStep == stepsItems.length) {
                    $('body').find('#seller_form').submit();
                }
                if (that.currentStep == stepsItems.length - 1) {
            ...
            validate = function(step, direction, event, checkStep) {
...
//                        steps = that.$element.find('.steps'),
//                        stepsItems = that.$element.find('.steps > li');
//                var parent_fieldset = $(this).find('.steps-content .step-pane[data-step="' + that.currentStep + '"]');
                var next_step = true;
//                console.log(parent_fieldset);

                $('.steps-content div[data-step="' + this.currentStep + '"] fieldset').find('.require').each(function(e) {
//alert();
                    if ($(this).val() == "") {
            ...
            methods = {
                ...
                next: function(checkStep, event) {
                    validate.call(this, false, true, event, checkStep);
                },
