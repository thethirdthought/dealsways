...
<!--                        <p>
            ...
            <form role="form" id="seller_form" action="<?php echo site_url() ?>/user/seller_reg" method="post" class="">
                                        ...
                                        <div class="form-bottom">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-12 col-sm-12">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" name="txt_phone2" placeholder="Phone No 2" class="form-last-name form-control require" id="txt_phone2">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-sm-12 col-sm-12">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" name="txt_phone3" placeholder="Phone No 3" class="form-last-name form-control require" id="txt_phone3">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-sm-12 col-sm-12">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" name="txt_phone4" placeholder="Phone No 4" class="form-last-name form-control require" id="sup_phone">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-sm-12 col-sm-12">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" name="txt_phone5" placeholder="Phone No 1" class="form-last-name form-control require" id="sup_phone">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-sm-12 col-sm-12">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" name="txt_phone6" placeholder="Phone No 1" class="form-last-name form-control require" id="sup_phone">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-12">
                                                    <div class="col-sm-4">
                                                        <label class="" for="sup_address_1">Address Line 1</label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <input type="text" name="txt_address1" placeholder="Address Line 1" class="form-last-name form-control require" id="sup_address_1">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-12">
                                                    <div class="col-sm-4">
                                                        <label class="sr" for="sup_city">City</label>
                                                    </div>
                                                    <div class="col-sm-8">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-12">
                                                    <div class="col-sm-4">
                                                        <label class="sr" for="sup_state">State</label>
                                                    </div>
                                                    <div class="col-sm-8">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-12">
                                                    <div class="col-sm-4">
                                                        <label class="sr" for="txt_pincode1">Zip</label>
                                                    </div>
                                                    <div class="col-sm-8">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-12">
                                                    <div class="col-sm-4">
                                                        <label class="" for="sup_address_1">Address 2</label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <input type="text" name="txt_address2" placeholder="Address 2" class="form-last-name form-control require" id="sup_address_1">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-12">
                                                    <div class="col-sm-4">
                                                        <label class="sr" for="sup_city">City 2</label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <input type="text" name="txt_city2" placeholder="City" class="form-last-name form-control require" id="sup_city">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-sm-12">
                                                    <div class="col-sm-4">
                                                        <label class="sr" for="sup_state">State2</label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <input type="text" name="txt_state2" placeholder="State" class="form-last-name form-control require" id="sup_state">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-sm-12">
                                                    <div class="col-sm-4">
                                                        <label class="sr" for="sup_country">Country2</label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <input type="text" name="txt_country2" placeholder="Country" class="form-last-name form-control require" id="sup_country">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-sm-12">
                                                    <div class="col-sm-4">
                                                        <label class="sr" for="txt_pincode1">Zip 2</label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <input type="text" name="txt_pincode12" placeholder="Zip" class="form-last-name form-control require" id="sup_zip">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-bottom">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-12">
                                                    <div class="col-sm-4">
                                                        <label class="sr" for="txt_reg_date">Registration Date</label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <input type="text" name="txt_reg_date" placeholder="Year Of Registration" class="form-last-name form-control" id="txt_reg_date">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                        ...
                                        <div class="form-bottom">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-12">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select name="txt_close_day[]" placeholder="Closing Days" class="form-last-name form-control require" id="sup_close_day" multiple>
                                        ...
                                        <div class="form-bottom">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-12">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select name="txt_target_age" placeholder="" class="form-last-name form-control" id="sup_target_age" >
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-12">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select name="txt_target_gender" placeholder="" class="form-last-name form-control" id="sup_target_gender" >
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-12">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select name="txt_target_crowd" placeholder="" class="form-last-name form-control" id="sup_target_crowd" multiple>
