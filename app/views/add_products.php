                ...
                <div class="panel-body">
                    ...
                    <div class="col-sm-12 work">
                        ...
                        foreach ($products as $product) {
                            $prod=json_decode($product['product_image']);
                                    ?>
                                    <figure class="white">
                                        <div><img src="<?php echo $prod[0] ?>" alt="Product Image" style="width: 100% ;" height="200"></div>
                                        <div id="wrapper-part-info">
                                            <div id="part-info"> <?php echo $product['product_name'] ?></div>
                                        </div>
                                    </figure>
            ...
            <div class="modal-body">
                <form method="post" id="form_modal" action="<?php echo site_url(); ?>/user/save_product" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                <input type="hidden" name="suplier_id" id="suplier_id" value="<?php echo $sup_id; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                <input type="text" id="product_brand" name="product_brand" value="" class="form-control">
                            </div><!-- /.form-group -->
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                <input type="text" id="product_price" name="product_price" value="" class="form-control">
                            </div><!-- /.form-group -->
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group clockpicker">
                                <textarea type="text" id="product_description" name="product_description" value="" class="form-control"></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                <input type="file" id="product_image" name="product_image[]" value="" class="form-control" multiple>
                            </div><!-- /.form-group -->
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                <input type="file" id="product_video" name="product_video" value="" class="form-control">
                            </div><!-- /.form-group -->
                        </div>
                    </div>
