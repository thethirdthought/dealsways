...
<section id="fh5co-whywe" data-section="whywe">
		<div id="fh5co-footer" style="background: #3f5267;color: #74889e;">
			<div class="container">
				<div class="row">
					<div class="col-md-4 to-animate">
						<h3 class="section-title fh5co-p">About Us</h3>
						<p>We introduce ourselves as an pioneer in digital advertisement. We are implementing different dimension to bring advertisor and publisher on a common platform and generating a common benefit. We present a unique product as INDO-SCREEN, which provide remotely controlled digital advertisement system.</p>
						
					</div>

					<div class="col-md-4 to-animate">
						<h3 class="section-title fh5co-p">Our Address</h3>
						<ul class="contact-info">
							<li>303 IIIrd FLOOR, C-210, SECTOR-N ,ORCHID SHYAM APARTMENT, KURSI ROAD, ALIGANJ, LUCKNOW, U.P 226024</li>
							<li>+91-(7668)-188-188</li>
							<li><a href="#">info@indoways.com</a></li>
							<li><a href="#">http://indoadways.com</a></li>
						</ul>
<!--						<h3 class="section-title fh5co-p">Connect with Us</h3>
					...
					<div class="col-md-4 to-animate ">
						<h3 class="section-title fh5co-p">Drop us a line</h3>
    ...
    <div class="footer" id="footer">
        <div class="container">
            ...
            <ul class=" pull-right navbar-link footer-nav">
                <li> &copy; <?php echo date('Y')." Dealsways";?></li>
            </ul>
        </div>
...
<script src="<?php echo base_url();?>assets/js/angular/angular_component.js"></script>
